...
# Pergrid <- Pergrid %>%
#     filter(`TMA-loc` %in% c("TMA131-f9.rdata","TMA135-g1.rdata",
#     "TMA135-g3.rdata","TMA135-g4.rdata",
#     "TMA147-d2.rdata","TMA147-e2.rdata",
#     "TMA147-h1.rdata","TMA119-j9.rdata","TMA139-a4.rdata","TMA143-b4.rdata"))
